...
export function Home() {
  ...
  usePageMeta(
    ...
    locale === 'ru'
      ? 'Закрытые визиты на производства и в штаб-квартиры лидеров индустрий Китая. Более 900 компаний, 17 отраслей — прямой доступ, куда не попасть самостоятельно.'
      : "Private visits to production sites and headquarters of China's industry leaders. 900+ companies across 17 sectors — direct access you can't reach on your own.",
  )
