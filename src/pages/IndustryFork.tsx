...
export function IndustryFork() {
  ...
  return (
    <section className="mx-auto max-w-[1280px] px-6 py-16 lg:py-20">
      <Link to="/industries" className="inline-flex items-center gap-1 text-sm text-ash-gray hover:text-bone-white">
      ...
      <div className="mt-12 grid max-w-2xl grid-cols-1 gap-4 sm:grid-cols-2">
        <Link
          ...
          className="rounded-2xl border border-black/10 bg-surface/60 p-6 transition-colors hover:border-electric-iris/60"
        >
