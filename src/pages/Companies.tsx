...
export function Companies() {
  ...
  usePageMeta(
    ...
    locale === 'ru'
      ? `Каталог из более чем 900 китайских компаний по ${companiesData.sectors.length} отраслям — название, сфера деятельности и краткое описание каждой.`
      : `A catalogue of 900+ Chinese companies across ${companiesData.sectors.length} sectors — name, business focus and a short description for each.`,
  )
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <p className="mt-6 max-w-2xl text-lg font-normal text-silver-mist">
        {locale === 'ru'
          ? `Более 900 компаний по ${companiesData.sectors.length} отраслям — выберите индустрию или найдите компанию по названию.`
          : `900+ companies across ${companiesData.sectors.length} sectors — filter by industry or search by name.`}
      </p>
